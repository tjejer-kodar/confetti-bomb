...
const chooseParticleColor = (groupName) => {
  let colors = ["red", "beige", "dimgray", "maroon", "silver"]
...
const bang = (addConfettiParticles) => {
  ...
  addConfettiParticles({
    groupName: 'confetti',  // Valfritt namn på gruppen
    ...
    yVelocity: 0,       // Hastighet i höjdled, positiva värden åker uppåt och negativa värden nedåt
